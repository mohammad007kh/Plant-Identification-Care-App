...
| US6        | P3       | FR-012         | T-110 ✅, T-111                        | 🟡 In progress (T-110 done: AI chat send/history, tenancy-scoped, metered; frontend = T-111, wiring = T-117)                                                                                 |
| US6        | P3       | FR-013         | T-110 ✅, T-111                        | 🟡 In progress (T-110 done: free-tier 10-message cap then metered; paid tiers metered from message 1; frontend = T-111)                                                                      |
...
| US7        | P3       | FR-022         | T-120 ✅, T-121                        | 🟡 In progress (T-120 done: per-user email/push toggles honored server-side; frontend toggle UI = T-121)                                                                                     |
...
| US9        | P3       | FR-024         | T-140 ✅, T-142                        | 🟡 In progress (T-140 done: admin species catalog CRUD + tier config behind an admin-role guard; admin frontend = T-142, wiring = T-147)                                                     |
| US9        | P3       | FR-025         | T-022 ✅, T-141 ✅, T-142              | 🟡 In progress (report submission + admin triage list done; admin frontend = T-142)                                                                                                          |
| US9        | P3       | FR-026         | T-141 ✅, T-142                        | 🟡 In progress (T-141 done: admin user search/detail + credit/tier adjust with audit; admin frontend = T-142)                                                                                |
