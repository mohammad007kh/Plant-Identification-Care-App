...
| ---------- | -------- | -------------- | -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| US1        | P1       | FR-001         | T-014 ✅, T-020 ✅, T-023        | 🟡 In progress (T-020 done: POST /scans accepts a single image via T-014's validation pipe; frontend upload UI = T-023)                                                                           |
...
| US1        | P1       | FR-003         | T-015 ✅, T-020 ✅, T-023        | 🟡 In progress (T-020 done: worker enforces the 70% gate — species withheld + low-confidence prompt below 0.70, tested; result-screen UX = T-023)                                                 |
