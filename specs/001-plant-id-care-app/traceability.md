...
| US3        | P2       | FR-009         | T-060 ✅, T-061                        | 🟡 In progress (T-060 done: save-from-scan + tenancy-scoped plants list/detail + follow-up photo history; frontend = T-061, wiring = T-077)                                                  |
...
| US9        | P3       | FR-025         | T-022 ✅, T-141, T-142                 | 🟡 In progress (T-022 done: POST /misidentification-reports — guest+auth, ownership-checked, snapshots scan result/photo, Zod-validated; admin triage side = T-141/T-142)                    |
