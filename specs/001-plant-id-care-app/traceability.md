...
| ---------- | -------- | -------------- | -------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| US1        | P1       | FR-001         | T-014 ✅, T-020 ✅, T-023              | 🟡 In progress (backend + frontend upload done — gallery/camera picker + client image-only guard; route wiring/nav = T-037)                                                                  |
...
| US1        | P1       | FR-003         | T-015 ✅, T-020 ✅, T-023              | 🟡 In progress (backend 70% gate + frontend result/low-confidence screens done; route wiring/nav = T-037)                                                                                    |
...
| US3        | P2       | FR-009         | T-060 ✅, T-061 ✅                     | 🟡 In progress (backend + frontend done: tenancy-scoped plant list/detail/photo-history UI; final route wiring/nav = T-077)                                                                  |
...
| US5        | P3       | FR-011         | T-100 ✅, T-101 ✅                     | 🟡 In progress (backend + comparison UI done: submit follow-up photo → poll → health verdict/trend display; final wiring = T-107)                                                            |
| US6        | P3       | FR-012         | T-110 ✅, T-111 ✅                     | 🟡 In progress (backend + chat UI done: metered AI plant-care chat thread w/ history + upgrade-on-402; final wiring = T-117)                                                                 |
| US6        | P3       | FR-013         | T-110 ✅, T-111 ✅                     | 🟡 In progress (backend + UI done: free-tier cap then metered, reflected in the chat composer; final wiring = T-117)                                                                         |
...
| US4        | P2       | FR-016         | T-080 ✅, T-082 ✅, T-083 ✅, T-097    | 🟡 In progress (backend + billing UI done: plans, balance, upgrade modal, mock checkout/return; final wiring = T-097)                                                                        |
...
| US7        | P3       | FR-020         | T-120 ✅                               | 🟡 In progress (T-120 done: per-plant care-reminder scheduler + email(primary)/web-push via swappable MailPort/PushPort, idempotent sends; frontend prefs = T-121, wiring = T-127)           |
| US7        | P3       | FR-021         | T-120 ✅, T-140 ✅                     | 🟡 In progress (admin-writable notification_config consumed by the reminder scheduler; frontend prefs = T-121)                                                                               |
| US7        | P3       | FR-022         | T-120 ✅, T-121 ✅                     | 🟡 In progress (backend + UI done: per-user email/push toggles + browser push opt-in; final wiring/nav = T-127)                                                                              |
| US8        | P3       | FR-023         | T-130 ✅, T-131 ✅                     | 🟡 In progress (backend + UI done: request/cancel with 7-day grace, danger-zone confirm + pending-deletion banner; final wiring = T-137)                                                     |
| US9        | P3       | FR-024         | T-140 ✅, T-142 ✅                     | 🟡 In progress (backend + admin catalog/tier UI done; final route wiring = T-147)                                                                                                            |
| US9        | P3       | FR-025         | T-022 ✅, T-141 ✅, T-142 ✅           | 🟡 In progress (report submission + admin triage list + admin review UI done; final wiring = T-147)                                                                                          |
| US9        | P3       | FR-026         | T-141 ✅, T-142 ✅                     | 🟡 In progress (admin user search/detail + credit/tier adjust w/ audit, backend + UI; final wiring = T-147)                                                                                  |
| US9        | P3       | FR-027         | T-140 ✅, T-142 ✅                     | 🟡 In progress (admin live-config write API + config-editor UI; final wiring = T-147)                                                                                                        |
...
| Cross      | —        | FR-030         | T-161 ✅, T-191                        | 🟡 In progress (T-161 done: AI circuit-breaker + typed outage errors → 503; frontend error boundary + offline banner + no-credit-lost messaging; gate = T-191)                               |
