...
| US1        | P1       | FR-002         | T-015 ✅, T-020               | 🟡 In progress (T-015 done: AiGatewayService.identify behind swappable PlantAIProvider + retry/backoff; HTTP scan endpoint = T-020)                                                       |
| US1        | P1       | FR-003         | T-015 ✅, T-020, T-023        | 🟡 In progress (T-015 done: 70% confidence gate withholds species below AI_CONFIDENCE_THRESHOLD; endpoint wiring/UX = T-020/T-023)                                                        |
...
| US4        | P2       | FR-015         | T-015 ✅, T-020, T-100, T-110 | 🟡 In progress (T-015 done: CreditsService.runMeteredAction reserves via atomic conditional debit — no overspend under concurrency; per-action metering at endpoints = T-020/T-100/T-110) |
| US4        | P2       | FR-016         | T-080, T-082, T-083, T-097    | 🔴 Pending                                                                                                                                                                                |
| US4        | P2       | FR-017         | T-015 ✅, T-020               | 🟡 In progress (T-015 done: refund-on-failure + refund-once via usage_record.refund_txn_id + reconciliation sweep for stuck-pending; endpoint = T-020)                                    |
