...
| US5        | P3       | FR-011         | T-100 ✅, T-101                        | 🟡 In progress (T-100 done: metered health comparison worker + verdict persisted; frontend = T-101, wiring = T-107)                                                                          |
...
| US8        | P3       | FR-023         | T-130 ✅, T-131                        | 🟡 In progress (T-130 done: request/cancel/status + delayed purge job, FK-safe data wipe + S3 delete + PII-free audit; frontend = T-131, wiring = T-137)                                     |
